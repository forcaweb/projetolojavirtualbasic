      ...
      <form method='post'>
        <div className='imgsAmost'>
          ...
          <div className='largeImgs'>
            <img className='imgSelect' src={imagens.img5} alt='' />
          </div>
        </div>

        <div className='detailsProduct'>
          <div className='nameProduct'>Camera Gopro</div>
          ...
          <div className='tamProduct'>
            <p>Votagem:</p>
            <select>
              <option value='220'>220 Vots</option>
              <option value='110'>110 Vots</option>
              <option value='bivolts'>Bivolts</option>
            </select>
          </div>
